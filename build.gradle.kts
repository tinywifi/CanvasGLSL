...
dependencies {
    val imguiVersion = properties["imgui_version"] as String
    ...
    // ImGui
    modImplementation(include("io.github.spair:imgui-java-binding:$imguiVersion")!!)
    modImplementation(include("io.github.spair:imgui-java-lwjgl3:$imguiVersion")!!)
